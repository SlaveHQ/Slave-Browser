All notable changes to Slave Agent are documented here. For the full release history with download links, see our [GitHub Releases](https://github.com/slave agent-ai/Slave Agent/releases).
...
- **New MCP tools** — A tighter, more reliable browser tool surface for agents, rebuilt from the ground up. Plus one-click install of Slave Agent as an MCP server into the agents you already run, with automatic URL sync.
- **Slave Browser 148** — Updated to the latest Slave Browser base with all recent upstream fixes and security patches
...
- **ChatGPT Pro & GitHub Copilot** — Already paying for ChatGPT Pro, Plus, or GitHub Copilot? Use that subscription to automate browser tasks in Slave Agent at no extra cost — just log in with your existing account.
...
- **Kimi K2.5** — In partnership with Moonshot AI, Kimi K2.5 is now the default model in Slave Agent — open-source, multimodal, and great for browser automation. Bring your own key from [platform.moonshot.ai](https://platform.moonshot.ai/) anytime.
...
- **Vertical tabs** — One of the most requested features is here. Slave Agent now ships with vertical tabs by default. More screen space, better tab management, and a cleaner layout out of the box. Prefer horizontal? You can switch back anytime in settings. [Read more →](/slave agent/features/vertical-tabs)
...
- **Slave Browser 146** — Updated to the latest Slave Browser release with all recent upstream fixes and security patches

<Frame>
  <img src="/images/changelog/0.42.0/soul-memory.png" alt="Slave Agent v0.42.0 SOUL.md feature for agent personalization" />
</Frame>

<Frame>
  <img src="/images/changelog/0.42.0/vertical-tabs.png" alt="Slave Agent v0.42.0 vertical tabs toggle in settings" />
</Frame>
...
- **Slave Browser 145** — Upgraded to the latest Slave Browser base with all recent upstream fixes and security patches
...
<Frame>
  <img src="/images/changelog/0.39.0-sync-mcp.png" alt="Slave Agent v0.39.0 featuring Sync and improved MCP connectors" />
</Frame>
...
<img src="/slave agent/features/workflow/sample-workflow.png" alt="Workflows visual graph builder showing a data entry automation" />

- **Cowork** — Describe an outcome, step away, and come back to finished work. Combine browser automation with local file operations—research on the web and save reports, scrape data and export to files, all in one task. [Read more →](/slave agent/features/cowork)

<img src="/slave agent/features/cowork/cowork-research-example.png" alt="Agent researching Hacker News and generating an HTML report" />
...
- **Gemini 3 support** — Gemini 3 Pro and Flash models now work with Slave Agent
- **Windows icon fix** — The Windows icon now displays Slave Agent logo correctly
...
A complete revamp of Slave Agent.
...
- **Slave Browser 142** — Updated to Slave Browser 142.0.7444.49
...
<Note>
For older releases, see the [full release history on GitHub](https://github.com/slave agent-ai/Slave Agent/releases).
</Note>
