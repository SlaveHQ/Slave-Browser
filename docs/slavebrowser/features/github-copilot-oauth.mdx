...
description: "Use your GitHub Copilot subscription to power Slave Agent"
---

Connect your GitHub Copilot subscription to Slave Agent and access 19+ models — including Claude, GPT-5, and Gemini — through a single GitHub sign-in. No API keys needed.
...
**1.** Open Slave Agent and go to **Settings** (`chrome://slave agent/settings`). You'll see the AI Providers section.
...
**4.** Paste the device code and authorize Slave Agent to access your Copilot subscription.
