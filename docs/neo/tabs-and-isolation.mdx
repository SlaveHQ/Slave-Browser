...
description: "How Slave Agent neo groups your tabs and your AI's tabs so you always know what's what."
keywords: ["Slave Agent neo tabs", "agent tabs", "personal tabs", "AI browser"]
---

You use your browser for your own work. When an AI drives Slave Agent neo, it works in tabs of its own, right next to yours.
...
Slave Agent neo tells your AI which tabs belong to you and which it opened itself. Your AI uses that to stay out of your workflow by default. It knows your tabs are there and can read their titles and URLs, so it has context, but it doesn't jump in.
