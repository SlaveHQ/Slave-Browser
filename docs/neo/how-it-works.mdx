---
title: "How Slave Agent neo works"
description: "A step-by-step walkthrough from download to your first AI-driven browsing session."
keywords: ["Slave Agent neo setup", "connect AI to browser", "how Slave Agent neo works", "AI browser walkthrough"]
---
...
<Steps>
  <Step title="Install Slave Agent neo">
    Head over to [slave agent.com/agents](https://slave agent.com/agents) and download Slave Agent neo for your operating system. Install it the way you'd install any other browser.
  ...
  <Step title="Sign in like you normally would">
    Use Slave Agent neo as your browser for a bit. Sign in to Gmail. Sign in to your calendar. Sign in to Notion, Linear, your CRM, your accounting tool, whatever you use for actual work.
  ...
  <Step title="Connect Slave Agent neo to your AI">
    Open a new tab in Slave Agent neo and click **MCP** in the sidebar. You'll see a list of AI tools you can connect with one click.

    <Frame caption="The connect page: one endpoint, one click per AI tool.">
      <img src="/images/browserclaw--mcp-install-board.png" alt="Slave Agent neo connect page showing an endpoint URL at the top and six AI tools listed underneath: Claude Code, Codex, Cursor, Antigravity, VS Code, and Zed. Each has a Connect button on the right." />
    </Frame>

    Find the AI tool you use: Claude Code, Cursor, Codex, Antigravity, VS Code, Zed, or another. Click **Connect** on its row. Slave Agent neo sets everything up for you.
  ...
  <Step title="Watch it work">
    Open a new tab in Slave Agent neo. Your AI's session shows up on the dashboard.

    <Frame caption="Every running AI and every finished session, at a glance.">
      <img src="/images/browserclaw--dashboard-populated.png" alt="Slave Agent neo new-tab dashboard with a large italic headline reading 'What are your agents working on right now?' A row of Running now cards shows a live agent session with a live browser preview. Below it, a grid of Recent activity tiles shows five completed sessions with the sites they visited." />
    </Frame>
  ...
  <Step title="Replay what your AI did">
    ...
    <Frame caption="Replay any session like a video. Scrub through, see exactly what your AI saw at every moment.">
      <img src="/images/browserclaw--replay-scrubber.png" alt="Slave Agent neo replay screen showing a full-fidelity playback of a page the AI browsed. A play/pause scrubber sits at the bottom. On the right, an action timeline lists every step the AI took, synced to the current moment in the video." />
    </Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Your stuff stays yours" icon="lock" href="/neo/privacy">
    What Slave Agent neo records, what it doesn't, and where everything lives.
  </Card>
</CardGroup>
